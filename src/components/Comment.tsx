...
function Comment({
          ...
          comments.map((comment) => {
            if (comment.id === replyingTo) {
              return {
                ...comment,
                replies: [
                  { ...data, commenter: user, createdAt: new Date() },
                  ...comment.replies,
                ],
              };
            }
  ...
  return (
    ...
    >
      ...
      >
        <div className="bg-[#EAECF1] h-24  mr-4 px-[0.8rem] py-1 rounded-lg sm:flex flex-col justify-evenly items-center hidden ">
          <div className="">
            <svg
              width="11"
              height="11"
        ...
        <div className="w-full">
          <div className="flex justify-between items-center w-full pb-3">
            ...
            <div className="hidden sm:flex justify-end items-center flex-row-reverse">
              <button
                onClick={() => setShowReply(!showReply)}
                className="hover:opacity-50 flex items-center justify-center text-sm text-[#5457B6] font-medium mx-2"
              >
              ...
              {user.id === authorId && (
                <>
                  ...
                  <button className="hover:opacity-50 flex items-center justify-center text-sm text-[#ED6468] font-medium mx-2">
                    <svg
                      width="12"
                      height="14"
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="flex justify-between items-center mt-4 mb-1 sm:hidden">
