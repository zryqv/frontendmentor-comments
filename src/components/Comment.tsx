      ...
      {showDelete && (
        <>
          <div
            ...
            className='bg-black bg-opacity-60 flex justify-center items-center w-screen h-screen absolute top-0 right-0 z-50'
          >
            <div
              onClick={(e) => e.stopPropagation()}
              className='bg-white 
         rounded-lg px-5 py-4 w-[20rem]'
            >
              <h1 className='font-bold text-xl leading-10 text-[#324152] mb-4'>
                Delete comment
              </h1>
              <p className='text-[#67727E] text-sm mb-7'>
              ...
              <div className='flex justify-start items-center w-full  my-4'>
                <button
                  onClick={() => setShowDelete(false)}
                  className=' block bg-[#67727E] uppercase self-end rounded-md px-4 py-2 text-white hover:opacity-50 mr-3'
                >
                  No, Cancel
                </button>
                <button
                  onClick={handleDelete}
                  className='block bg-[#ED6468] uppercase self-end rounded-md px-4 py-2 text-white hover:opacity-50 '
                >
                  Yes, Delete
                </button>
              </div>
      ...
      <div
        className={`${
          isReply
            ...
            : hasReplies
            ? 'w-[100%]'
            : 'w-[94%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%]'
        } my-2`}
      >
        <div
          className='bg-white 
